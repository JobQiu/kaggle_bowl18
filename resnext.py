...
def ResNext(input_shape=None, depth=29, cardinality=32, width=4, weight_decay=5e-4,
...
def __create_res_next_c2_c5(nb_classes, img_input, include_top, depth=29, cardinality=8, width=4,
                      weight_decay=5e-4, pooling=None):
    ''' Creates a ResNeXt model with specified parameters
    Args:
        nb_classes: Number of output classes
...
def _MaskRCNN__create_res_next_c2_c5(nb_classes, img_input, include_top, depth=29, cardinality=8, width=4,
                      weight_decay=5e-4, pooling=None):
    ''' Creates a ResNeXt model with specified parameters
    Args:
        nb_classes: Number of output classes
...
if __name__ == '__main__':
    model = ResNext((256, 256, 3), depth=[3,4,6,3], cardinality=32, width=4)
    model.summary()
    """
